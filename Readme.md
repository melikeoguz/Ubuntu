...
<button type="button" style="background-color: #ff9f40; border: none; color: white; padding: 15px 22px; text-align: center; text-decoration: none; display: inline-block; font-size: 16px; margin: 4px 0px; margin-left: 0px;cursor: pointer; border-radius: 4px; onclick="https://github.com/melikeoguz/Ubuntu/blob/master/170201028%20Melike%20Oğuz.pdf" class="btn btn-{{include.button_class}} active">İsterlerin Yapılışını Görüntele</button>
